 ...
 *
 * IPercentageDecorator is an interface that extends the IObserver interface,
 * adding functionality specific to percentage reports. It follows the Decorator
 * Design Pattern, allowing dynamic addition of attributes to objects.
 */
class IPercentageDecorator : public IObserver {
 ...
 public:
   ...
   *
   * Initializes an IPercentageDecorator with a reference to an IObserver
   * object, decorating it with additional functionality.
   *
