/**
 * @file Publisher.h
 * @brief Header file for the Publisher class, implementing the Publisher part of the Observer pattern.
 */
#ifndef PUBLISHER_H_
#define PUBLISHER_H_
 ...
 *
 * The Publisher class handles the addition, removal, and notification of observers.
 * It maintains a list of observers and provides methods to add or remove observers. Additionally,
 * it includes functionality to notify all registered observers about changes.
 */
class Publisher {
 public:
   /**
   ...
   *
   * Removes an observer from the Publisher, stopping it from receiving further notifications.
   *
   ...
   *
   * Triggers the update method on all registered observers, informing them of a change.
   *
   ...
   *
   * Designates a specific observer by its ID as the main recipient of notifications.
   *
